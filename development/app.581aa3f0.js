...
var Header = function Header() {
  var template = "\n    <header>\n      <h1>My Parcel App</h1>\n      <p>This is a bolierplate for a simple JS workflow using parcel</p>\n    </header>\n  ";
  return template;
};
  ...
  var _ref = (0, _asyncToGenerator2.default)( /*#__PURE__*/_regenerator.default.mark(function _callee() {
    return _regenerator.default.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            document.getElementsByClassName('header')[0].innerHTML = (0, _Header.default)();
            _context.next = 3;
            return (0, _User.default)();

          case 3:
            document.getElementsByClassName('user')[0].innerHTML = _context.sent;
